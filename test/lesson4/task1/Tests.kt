...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("сто пятьдесят тысяч девятьсот шестьдесят шесть", russian(150966))
        assertEquals("восемьсот шестьдесят четыре тысячи триста пятьдесят", russian(864350))
        assertEquals("четыреста восемьдесят пять тысяч семьсот девяносто шесть", russian(485796))
        assertEquals("пятьсот одиннадцать тысяч двести пятьдесят пять", russian(511255))
    }
}