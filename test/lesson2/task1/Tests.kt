...
class Tests {
    ...
    fun segmentLength() {
        ...
        assertEquals(5, segmentLength(10, 15, 10, 15))
        assertEquals(678972, segmentLength(-999999, -321027, -999999, 482575))
        assertEquals(785762, segmentLength(-1000000, 482575, -1000000, -214238))
    }
}